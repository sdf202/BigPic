...
<body>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="sendReport">
						<input type="radio" name="report" value="spam" id="radio1">
						<label for="radio1"> 스팸<br> 오해의 소지가 있거나 반복적으로 게시되는
							게시물
						</label>
						<hr />
						<input type="radio" name="report" value="pornography" id="radio2">
						<label for="radio2"> 누드 또는 포르노<br> 노골적인 성적 콘텐츠
						</label>
						<hr />
						<input type="radio" name="report" value="suicide" id="radio3">
						<label for="radio3"> 자해<br> 섭식 장애, 자상, 자살 조장
						</label>
						<hr />
						<input type="radio" name="report" value="unpleasant" id="radio4">
						<label for="radio4"> 불쾌한 표현 또는 기호<br> 보호 그룹에 대한 공격
						</label>
						<hr />
						<input type="radio" name="report" value="insulting" id="radio5">
						<label for="radio5"> 모욕적인 내용 또는 사생활 침해<br> 위협, 협박, 인신
							공격
						</label>
						<hr />
						<input type="radio" name="report" value="violent" id="radio6">
						<label for="radio6"> 노골적표현 묘사<br> 폭력적인 이미지 또는 폭력 조장
						</label>
						<hr />
						<input type="radio" name="report" value="ipViolation" id="radio7">
						<label for="radio7"> 나의 지적 재산<br> 저작권 또는 상표권 침해
						</label>
						<hr />
						<button type="button" class="btn btn-secondary"
							data-dismiss="modal">취소</button>
						<button type="button" id="submit-form" class="btn btn-primary"
							data-toggle="modal" href="#stack2">다음</button>
					</form>
	...
	<div id="stack2" class="modal hide fade" tabindex="-1"
		data-focus-on="input:first" aria-labelledby="reportTitle"
		aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<form action="">
					<p>이러 저러한 이유로 신고 ㄱㄱㄱ?</p>
				<div>
				<button type="button" class="btn btn-secondary"
						data-dismiss="modal">취소</button>
					<button type="button" id="submit-form" class="btn btn-primary">다음</button>
				</div>
				</form>
				</div>
