...
<body>
	<div class="container" style="width: 100%; margin: auto;">
		<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
			<a class="navbar-brand" href="/bigPic/home.do"> <img
            ...
            <i class="fa fa-search"></i>
				...
				<ul class="navbar-nav navbar-right">
					<li class="nav-item active"><a class="nav-link"
						href="/bigPic/home.do">홈<span class="sr-only"></span></a></li>
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu dropdown-menu-right"
							...
							<a class="dropdown-item" href="#">무료계정 Business 계정만들기</a> <a
								...
								class="dropdown-item" href="#">도움 받기</a> <a
								class="dropdown-item" href="/bigPic/policy.do">약관 및 개인정보</a>
